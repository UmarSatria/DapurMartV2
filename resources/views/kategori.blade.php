...
@section('content')
    ...
    <body>
        <h1 style="text-align: center; font-weight: bold; margin-bottom: 4rem">KATEGORI</h1>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4" style="display: flex; gap: 1px;">
                                <button data-modal-target="update-modal-{{ $item->id }}"
                                    ...
                                    style="margin-bottom: 2rem; background-color: transparent; border: none;"
                                    class="block text-black hover:text-gray-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white dark:hover:text-gray-300"
                                    type="button">
                                    <svg class="w-5 h-5 inline mr-2 text-black" aria-hidden="true"
        ...
        <div id="update-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="padding: 2rem">
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Update Category
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" action="{{ route('kategori.update', $item->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid gap-4 mb-4 grid-cols-2">
