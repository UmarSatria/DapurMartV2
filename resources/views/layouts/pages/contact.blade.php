            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                            class="text-white">Jalan Ijen Boulevard, Malang</a></small>
                    <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                            class="text-white">dapurmartl@gmail.com</a></small>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-12">
                        <div class="h-100 rounded">
                            <iframe class="w-100"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3385.321814817472!2d112.61926477423481!3d-7.9723620920526965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd62827d9a90075%3A0x918d59de4008c265!2sIdjen%20Boulevard!5e1!3m2!1sid!2sid!4v1729217164939!5m2!1sid!2sid"
                                width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                                referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <form action="{{ route('contact.index') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('POST')
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mx-auto">
                            ...
                            <input type="submit"
                                ...
                                style="top: 0; right: 0;" value="Subscribe Now" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3">
